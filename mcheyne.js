/* ============================================================
   THE M'CHEYNE BIBLE READING CALENDAR
   Robert Murray M'Cheyne, St. Peter's, Dundee, 30th Dec. 1842.

   Four readings a day. The first two are the "family" readings —
   meant to be read aloud with the house. The last two are the
   "secret" readings, for a man on his own. M'Cheyne took the word
   secret from Matthew 6:6.

   Read all four for a year and you finish the Old Testament once,
   and the New Testament and Psalms twice.

   Format per day: [family1, family2, secret1, secret2]
   ============================================================ */
...
window.MCHEYNE = {
  ...
  2: [
    ...
    ["Exodus 11, 12:1-21","Luke 14","Job 29","1 Corinthians 15"]
  ],
  3: [
  ...
  4: [
    ...
    ["Numbers 3","Psalms 37","Song of Solomon 1","Hebrews 1"],
    ["Numbers 4","Psalms 38","Song of Solomon 2","Hebrews 2"],
    ["Numbers 5","Psalms 39","Song of Solomon 3","Hebrews 3"],
    ["Numbers 6","Psalms 40, 41","Song of Solomon 4","Hebrews 4"],
    ["Numbers 7","Psalms 42, 43","Song of Solomon 5","Hebrews 5"]
  ],
  5: [
    ["Numbers 8","Psalms 44","Song of Solomon 6","Hebrews 6"],
    ["Numbers 9","Psalms 45","Song of Solomon 7","Hebrews 7"],
    ...
    ["Numbers 19","Psalms 56, 57","Isaiah 8, 9:1-7","James 2"],
    ["Numbers 20","Psalms 58, 59","Isaiah 9:8-21, 10:1-4","James 3"],
  ...
  6: [
    ...
    ["Deuteronomy 27, 28:1-19","Psalms 119:1-24","Isaiah 54","Matthew 2"],
    ...
    ["Joshua 1","Psalms 120, 121, 122","Isaiah 61","Matthew 9"],
    ["Joshua 2","Psalms 123, 124, 125","Isaiah 62","Matthew 10"]
  ],
  7: [
    ["Joshua 3","Psalms 126, 127, 128","Isaiah 63","Matthew 11"],
    ["Joshua 4","Psalms 129, 130, 131","Isaiah 64","Matthew 12"],
    ["Joshua 5, 6:1-5","Psalms 132, 133, 134","Isaiah 65","Matthew 13"],
  ...
  11: [
    ...
    ["2 Kings 16","Titus 2","Hosea 9","Psalms 126, 127, 128"],
...
/* M'Cheyne's own headings for each month, from the 1842 calendar. */
window.MCHEYNE_MOTTOS = {
  ...
  3: "Mary kept all these things, and pondered them in her heart.",
  4: "O send out thy light and thy truth; let them lead me.",
  5: "From a child thou hast known the holy Scriptures.",
  6: "Blessed is he that readeth and they that hear.",
  7: "They received the word with all readiness of mind, and searched the Scriptures daily.",
  8: "Speak, Lord; for thy servant heareth.",
  9: "The Law of the Lord is perfect, converting the soul.",
  10: "O how I love thy law! It is my meditation all the day.",
  11: "As new-born babes, desire the sincere milk of the word, that ye may grow thereby.",
  12: "The law of his God is in his heart; none of his steps shall slide."
};
